...
// 	// =============================================================================
// 	// STYLES  (font scale bumped ~2px for projection readability)
// 	// xs=13 sm=14 base=15 md=16 lg=17 xl=18
// 	// =============================================================================
...
// 		'.cb-table,.ppt-table-wrap{width:100%;border-collapse:collapse;table-layout:auto;font-family:var(--font);font-size:var(--fs-base);color:var(--txt);line-height:1.45;}' +
// 		'.cb-table th,.cb-table td,.ppt-table-wrap th,.ppt-table-wrap td{border:1.5px solid var(--bdl);padding:8px 12px;white-space:nowrap;text-align:right;font-family:var(--font);font-size:var(--fs-base);}' +
...
// 		'.cb-thead-main th{background:var(--blue-mid);color:#fff;font-family:var(--font);font-size:var(--fs-xl);font-weight:var(--fw-b);text-align:center !important;position:sticky;top:0;z-index:25;border-color:var(--bdh);padding:10px 12px;letter-spacing:.1px;}' +
// 		'.cb-thead-sub th{background:var(--orange);color:#fff;font-family:var(--font);font-size:var(--fs-lg);font-weight:var(--fw-sb);text-align:center !important;position:sticky;top:0;z-index:24;border-color:var(--bdo);min-width:110px;padding:8px 12px;}' +
// 		'.cb-row-head{font-family:var(--font);font-size:var(--fs-base);font-weight:var(--fw-b);cursor:pointer;background:var(--blue-light);color:var(--blue-dark);}' +
// 		'.cb-row-head td{font-size:var(--fs-base);font-weight:var(--fw-b);}.cb-row-head:hover td{background:#d0e8f5;}' +
// 		'.cb-row-sub{font-family:var(--font);font-size:var(--fs-base);font-weight:var(--fw-sb);cursor:pointer;background:var(--orange-light);}' +
// 		'.cb-row-sub td{font-size:var(--fs-base);font-weight:var(--fw-sb);}.cb-row-sub:hover td{background:#ffe0c2;}' +
// 		'.cb-row-grand td{background:var(--blue-mid) !important;color:#fff !important;font-family:var(--font);font-size:var(--fs-base);font-weight:var(--fw-b);border-color:var(--bdh) !important;}' +
...
// 		'.ppt-table-wrap thead tr.cb-thead-main th{border-color:var(--bdh);}' +
// 		'.ppt-table-wrap thead tr.cb-thead-sub th{border-color:var(--bdo);}' +
// 		'.ppt-table-wrap tbody tr td{background:#fff;color:var(--txt);font-family:var(--font);font-size:var(--fs-base);font-weight:var(--fw-n);}' +
// 		'.ppt-table-wrap tbody tr.ppt-total-row td{font-family:var(--font);font-size:var(--fs-base);font-weight:var(--fw-b);background:#e8f0fa !important;color:var(--blue-dark) !important;border-color:#aaa !important;}' +
...
// 		'#be-table thead tr.cb-thead-main th:first-child{position:sticky;left:0;z-index:50 !important;background:var(--blue-mid);text-align:left !important;min-width:280px;}' +
...
// 		'.sinr-table td,.sinr-table th{font-family:var(--font);font-size:var(--fs-base);}' +
// 		'.sinr-total-row td{font-weight:var(--fw-b) !important;background:#e8f0fa !important;color:var(--blue-dark) !important;border-top:2px solid #aaa !important;}' +
// 		'.sinr-sub-item td:first-child{padding-left:22px !important;color:#444;}.sinr-covid-row td{color:#444;}' +
// 		'#sinr-table-a thead tr.cb-thead-main th:first-child{position:sticky;left:0;z-index:50 !important;background:var(--blue-mid);}' +
// 		'#sinr-table-a thead tr.cb-thead-sub th:first-child{position:sticky;left:0;z-index:49 !important;background:var(--orange);}' +
...
// 		'#sinr-table-b thead tr:nth-child(1) th{position:sticky;top:0;z-index:25;background:var(--blue-mid);color:#fff;font-family:var(--font);font-size:var(--fs-xl);font-weight:var(--fw-b);text-align:center !important;border-color:var(--bdh);padding:10px 12px;}' +
// 		'#sinr-table-b thead tr:nth-child(2) th{position:sticky;z-index:24;background:var(--orange);color:#fff;font-family:var(--font);font-size:var(--fs-lg);font-weight:var(--fw-sb);text-align:center !important;border-color:var(--bdo);padding:8px 12px;min-width:110px;}' +
...
// 		'#sinr-table-b thead tr:nth-child(1) th:first-child{z-index:55 !important;background:var(--blue-mid) !important;}' +
// 		'#sinr-table-b thead tr:nth-child(2) th:first-child{z-index:54 !important;background:var(--orange) !important;}' +
...
// 		'#sinr-table-b tbody tr.sinr-unit-hdr td:first-child{background:var(--blue-light) !important;}' +
...
// 		'#sinr-table-b tbody tr.sinr-gt-plan td:first-child,#sinr-table-b tbody tr.sinr-gt-act td:first-child{background:#ddeaf7 !important;}' +
// 		'#sinr-table-b tbody td{font-family:var(--font);font-size:var(--fs-base);text-align:right;padding:8px 12px;border:1.5px solid var(--bdl);white-space:nowrap;}' +
// 		'#sinr-table-b tbody tr.sinr-unit-hdr td{background:var(--blue-light);color:var(--blue-dark);font-weight:var(--fw-b);border-bottom:1px solid #c5ddf0;}' +
...
// 		'#sinr-table-b tbody tr.sinr-total-row td{font-weight:var(--fw-b);background:#e8f0fa;color:var(--blue-dark);border-top:2px solid #aaa;}' +
// 		'#sinr-table-b tbody tr.sinr-gt-plan td,#sinr-table-b tbody tr.sinr-gt-act td{background:#ddeaf7;color:var(--blue-dark);font-weight:var(--fw-sb);}' +
...
// 	// Always divide by 1 Cr (1,00,00,000). e.g. 3,600,000 -> 0.36
// 	function fmtCr(v) {
...
// 	// Indian grouping for whole-number columns (Annual / Estimate / B&E)
...
// 		// Retry up to 10 times (50ms apart) until the main-header row has a real height.
// 		// getBoundingClientRect can return 0 before the browser has laid out the table.
// 		var attempts = 0;
// 		function attempt() {
// 			var $t = $(sel);
...
// 		'<div class="ppt-currency-label">&#8377; <strong>Cr.</strong></div>' +
// 		'<div class="cb-scroll-wrapper"><table id="ppt-prev-table" class="ppt-table-wrap"><thead>' +
...
// 		'<tr class="cb-thead-sub"><th>Opex</th><th>Capex</th><th>Total</th><th>Opex</th><th>Capex</th><th>Total</th></tr>' +
// 		'</thead><tbody id="ppt-prev-tbody"></tbody></table></div></div>' +
...
// 				// Skip the rolled-up GRAND TOTAL section (seq 9999) in first pass
...
// 			});
// 			// Fallback: no OPERATING/CAPITAL sections found — use GRAND TOTAL section value as opex
// 			if (!hasBreakdown) {
// 				(sections || []).forEach(function (sec) {
...
// 					}
// 				});
// 				// If still nothing, sum ALL non-GT sections
// 				if (!opex) {
// 					(sections || []).forEach(function (sec) {
// 						if (sec.sequence_id !== 9999 && normSec(sec.name) !== 'GRAND TOTAL') {
// 							opex += parseFloat(sec[field] || 0);
...
// 		}
// 		// Read the GRAND TOTAL section (seq 9999) directly for the Total column
...
// 				}
// 			});
// 			// Fallback: if no GT section, sum all sections
// 			if (!gt) {
// 				(sections || []).forEach(function (sec) {
// 					gt += parseFloat(sec[field] || 0);
// 				});
...
// 				callback: function (r) {
// 					Loader.hide();
// 					var d = Array.isArray(r.message) ? r.message : ((r.message && Array.isArray(r.message.message)) ? r.message.message : []);
// 					if (!d.length) { $('#ppt-tbody,#ppt-prev-tbody').html('<tr><td colspan="7" style="text-align:center;padding:24px;color:#aaa;">No data.</td></tr>'); return; }
// 					var p = (fy || '2025-26').split('-');
...
// 					var r0 = buildRows(d, cCfg), r1 = buildRows(d, pCfg);
...
// 					var toExp = function (rows) { return rows.map(function (r) { return { label: r.label, bOpex: r.bOpex, bCapex: r.bCapex, bTotal: r.bTotal, eOpex: r.eOpex, eCapex: r.eCapex, eTotal: r.eTotal, is_total: !!r.isTotal }; }); };
...
// 				},
// 				error: function () { Loader.hide(); $('#ppt-tbody,#ppt-prev-tbody').html('<tr><td colspan="7" style="text-align:center;padding:24px;color:red;">Error loading data.</td></tr>'); }
// 			});
// 		}
// 		return { load: load };
// 	})();
...
// 			return r;
// 		}
// 		// Extract CONSOLIDATED TOTAL entry (sequence_id 9999, table_name CONSOLIDATED)
...
// 			});
// 			// Fallback: compute total if OVERALL GRAND TOTAL not present
...
// 				// Skip the CONSOLIDATED TOTAL entry — it's used only for the Grand Total row
...
// 			});
// 			// Use CONSOLIDATED TOTAL if available, otherwise fall back to summing rows
...
// 			});
// 			// Use CONSOLIDATED TOTAL values for Grand Total row if available
...
// 					Store.summaryInr = d;
// 					// Filter out CONSOLIDATED TOTAL from unit rows; keep it for grand total reference
...
// 	// =============================================================================
// 	// ANNUAL BUDGET MODULE  — collapsed by default on load
// 	// =============================================================================
...
// 			data = []; openH = {}; openS = {}; expandedQ = [];          // collapsed by default
...
// 	// =============================================================================
// 	// ESTIMATE MODULE  — collapsed by default on load
// 	// =============================================================================
...
// 	// =============================================================================
// 	// BUDGET & ESTIMATE MODULE  — collapsed by default on load
// 	// openSec[sn] is undefined by default → secOpen = (openSec[sn] === true) = false
// 	// =============================================================================
...
// 				var sn = sec.name;
// 				var secOpen = openSec[sn] === true;     // undefined = false = collapsed
...
// 		function load(fy) {
// 			if (!bound) { bindEvents(); bound = true; }
// 			currentFY = fy; rawData = []; openSec = {}; openSub = {}; expandItems = false;   // collapsed by default
...
// 		// ── Education tables grouped by table_name (sub-items only) ──────────
// 		function buildEducationTables(data, cfg, bLbl, eLbl) {
// 			// Only entries where is_this_sub_item === 1
// 			var subItems = (data || []).filter(function (e) { return e.is_this_sub_item === 1; });
// 			if (!subItems.length) { return ''; }

// 			// Group by table_name, preserving insertion order
...
// 			// Build a map of table_name -> parent label (is_this_sub_item === 0)
// 			// This is what shows as the section title e.g. "Education"
// 			var parentLabelMap = {};
// 			(data || []).forEach(function (e) {
...
// 				// Use parent label as section title; fall back to table_name if not found
// 				var sectionTitle = "EDUCATION";

// 				// Safe DOM id for the table
// 				var tblId = 'ppt-edu-' + grp.replace(/\s+/g, '-').replace(/[^a-zA-Z0-9\-]/g, '');

// 				// Sub-item rows only — no parent row
// 				var bodyHtml = '';
// 				var tot = { bOpex: 0, bCapex: 0, bTotal: 0, eOpex: 0, eCapex: 0, eTotal: 0 };
...
// 					bodyHtml += '<tr>' +
// 						'<td style="text-align:left;font-style:italic;padding-left:28px;">- ' + (e.label || '') + '</td>' +
...
// 				// Total row — same blue style as the two tables above
...
// 				html +=
// 					/* Title — uses parent entry label, e.g. "EDUCATION" */
...
// 							'<thead>' +
// 								/* Blue main header — identical to ppt-table and ppt-prev-table */
...
// 					// Main tables use only non-sub-item entries
...
// 					// Education tables below — uses current year config for column labels
// 					var subHtml = buildEducationTables(d, cCfg, curFY + ' Budget', prvFY + ' Actual');
// 					$('#ppt-sub-tables').html(subHtml);

// 					// Fix sticky headers for every newly-injected sub table
...
// 					// Plain data row — same as the unit rows in ppt-tbody / ppt-prev-tbody
// 					bodyHtml += '<tr>' +
// 						'<td>' + (e.label || '') + '</td>' +
// 						'<td>' + fmtCrDash(b.opex)  + '</td>' +
// 						'<td>' + fmtCrDash(b.capex) + '</td>' +
...
// 				// FIX 2: ppt-total-row — no inline style needed, td:first-child already left-aligns
// 				bodyHtml += '<tr class="ppt-total-row">' +
// 					'<td>Total</td>' +
// 					'<td>' + fmtCrDash(tot.bOpex)  + '</td>' +
// 					'<td>' + fmtCrDash(tot.bCapex) + '</td>' +
...
// 		// ── Operating Expenses FY table — same data pattern as BudgetEstimate ──
// 		function buildOpexBudgetTable(entries, fyLabel) {
// 			if (!entries || !entries.length) { return ''; }

// 			// Find the operating section name (exact match, flexible spacing)
// 			function isOpex(name) {
// 				return (name || '').replace(/\s+/g, ' ').trim().toUpperCase().indexOf('OPERATING') !== -1;
// 			}

// 			// Get sub-head plan value from actuals — same as BudgetEstimate's subVal
...
// 			// Get operating section total plan — same as BudgetEstimate's secVal
...
// 			// Collect all sub-head names in order (from first entry that has them)
...
// 			// Inject sticky-col CSS once
// 			if (!$('#ppt-opex-style').length) {
// 				$('head').append(
// 					'<style id="ppt-opex-style">' +
// 					'#' + tblId + '{border-collapse:collapse;width:100%;}' +
// 					'#' + tblId + ' thead tr.cb-thead-main th:first-child{position:sticky !important;left:0;z-index:50 !important;background:var(--blue-mid) !important;text-align:left !important;min-width:260px;}' +
// 					'#' + tblId + ' tbody td:first-child{position:sticky;left:0;z-index:10;background:#fff;text-align:left !important;min-width:260px;box-shadow:2px 0 4px -2px rgba(0,0,0,.12);}' +
...
// 			// Single header row — unit names with FY label below as rowspan=1, no orange sub-row
// 			var hdrR1 = '<tr class="cb-thead-main">' +
// 				'<th style="min-width:260px;text-align:left !important;">Operating Sub-Head</th>';
// 			entries.forEach(function (e) {
...
// 					'<td>' + subName + '</td>' +
// 					cells +
// 					'<td style="font-weight:700;background:#ddeaf7;color:var(--blue-dark);border-left:2px solid var(--blue-mid);">' + fmtCrDash(rowTotal) + '</td>' +
// 				'</tr>';
// 			});

// 			// Total row — operating section total per unit (not sum of sub-heads)
// 			var totalCells = '';
...
// 				'<td>Total</td>' +
// 				totalCells +
// 				'<td style="font-weight:700;background:#e8f0fa !important;color:var(--blue-dark) !important;border-left:2px solid var(--blue-mid);">' + fmtCrDash(opexGrandTotal) + '</td>' +
// 			'</tr>';
...
// 					// Second API — hide loader only after this returns
// 					frappe.call({
// 						method: 'annual_budget.api.foundation_consolidated_report.get_unit_wise_plan',
// 						args: { financial_year: fy, month: 'March', table_name_filter: 'Unit Wise Plan' },
...
// 							$('#ppt-sub-tables').html(subHtml + opexHtml);
